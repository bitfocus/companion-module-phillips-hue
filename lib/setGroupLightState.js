...
function setLightGroup_Switch(user,id,onoff){
  console.log("setGroupLightState.js -> setLightGroup_Switch");
  // console.log(id)
  // console.log(onoff);
  console.log("this is my user name = "+user);
...
function setLightGroup_Switch_Bri(user,id,onoff,bri){
  console.log("setGroupLightState.js -> setLightGroup_Switch_Bri");
  // console.log(id)
  // console.log(onoff);
  console.log("this is my user name = "+user);
  if (onoff == 'true') {
...
function setZone_Switch(user,id,onoff){
  console.log("setGroupLightState.js -> setZone_Switch");
  // console.log(id)
  // console.log(onoff);
  console.log("this is my user name = "+user);
...
function setZone_Switch_Bri(user,id,onoff,bri){
  console.log("setGroupLightState.js -> setZone_Switch_Bri");
  // console.log(id)
  // console.log(onoff);
  console.log("this is my user name = "+user);
  if (onoff == 'true') {
